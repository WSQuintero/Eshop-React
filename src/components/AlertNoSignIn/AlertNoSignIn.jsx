...
function AlertNoSignIn () {
  return (
    <>
      ...
      <div className='absolute w-4/5 h-[50vh] bg-gray-400 text-yellow-100 font-bold border-2 border-yellow-100 flex justify-center items-center rounded-xl text-xl'>

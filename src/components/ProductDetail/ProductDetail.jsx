...
function ProductDetail () {
  ...
  return (
    <div
      ...
      className='fixed min-h-[100vh] w-[100%] flex justify-center bg-opacity-50  top-20 pt-10 inset-0 pointer-events-none'
    >
      <div className='w-5/6 h-[75vh] rounded-3xl bg-white   flex justify-center items-center flex-col p-8 relative pointer-events-auto'>
        <h3 className='font-bold text-center text-lg'>{title}</h3>
        <img src={images} alt='' className=' w-[30%] lg:w-[15%]  mt-5' />
